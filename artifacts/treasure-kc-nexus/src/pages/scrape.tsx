            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 border rounded-md bg-muted/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">Treasure Network Portal</p>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                When an LLC is marked as recruited, their details are automatically pushed to the Treasure Network portal via webhook to initiate the onboarding process.
              </p>
              <Button 
                variant="outline" 
